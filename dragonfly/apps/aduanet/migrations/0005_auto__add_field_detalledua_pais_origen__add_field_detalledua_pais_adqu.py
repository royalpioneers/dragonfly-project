...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DetalleDua.pais_origen'
        db.add_column('aduanet_detalledua', 'pais_origen',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pais_origen_set', null=True, to=orm['aduanet.CountryProduct']),
                      keep_default=False)

        # Adding field 'DetalleDua.pais_adquisicion'
        db.add_column('aduanet_detalledua', 'pais_adquisicion',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pais_adquisicion_set', null=True, to=orm['aduanet.CountryProduct']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DetalleDua.pais_origen'
        db.delete_column('aduanet_detalledua', 'pais_origen_id')

        # Deleting field 'DetalleDua.pais_adquisicion'
        db.delete_column('aduanet_detalledua', 'pais_adquisicion_id')
    ...
    models = {
        ...
        'aduanet.countryproduct': {
            'Meta': {'object_name': 'CountryProduct'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '5'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        ...
        'aduanet.detalledua': {
            ...
            'pais_adquisicion': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'pais_adquisicion_set'", 'null': 'True', 'to': "orm['aduanet.CountryProduct']"}),
            'pais_origen': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'pais_origen_set'", 'null': 'True', 'to': "orm['aduanet.CountryProduct']"}),
