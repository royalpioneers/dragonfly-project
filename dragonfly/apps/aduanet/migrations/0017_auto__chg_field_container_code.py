...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Container.code'
        db.alter_column('aduanet_container', 'code', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Container.code'
        db.alter_column('aduanet_container', 'code', self.gf('django.db.models.fields.CharField')(max_length=12))
