...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('aduanet_detalledua', 'guia_aerea_bl', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Importer.address'
        db.alter_column('aduanet_importer', 'address', self.gf('django.db.models.fields.CharField')(max_length=300))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Importer.address'
        db.alter_column('aduanet_importer', 'address', self.gf('django.db.models.fields.CharField')(max_length=120))
