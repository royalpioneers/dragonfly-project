...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Hts.nabandina'
        db.alter_column('aduanet_hts', 'nabandina', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

    def backwards(self, orm):

        # Changing field 'Hts.nabandina'
        db.alter_column('aduanet_hts', 'nabandina', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))
