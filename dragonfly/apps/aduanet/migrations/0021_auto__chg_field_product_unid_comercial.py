...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.unid_comercial'
        db.alter_column('aduanet_product', 'unid_comercial', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Product.unid_comercial'
        db.alter_column('aduanet_product', 'unid_comercial', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=20))
