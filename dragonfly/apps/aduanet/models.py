...
class Dua (models.Model):
    ...
    fecha_llegada = models.CharField(max_length=15, blank=True, null=True)
    ...
    total_series = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True)
    ...
    res_exo_num = models.DecimalField(max_digits=8, decimal_places=2, blank=True, null=True)
    ...
    ultimo_dia_pago = models.CharField(max_length=10, blank=True, null=True)
    fecha_cancelacion = models.CharField(max_length=10, blank=True, null=True)
    fecha_numeracion = models.CharField(max_length=10, blank=True, null=True)
