...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DetalleDua.igv'
        db.add_column('aduanet_detalledua', 'igv',
        ...
        # Adding field 'DetalleDua.peso_neto'
        db.add_column('aduanet_detalledua', 'peso_neto',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)


        # Changing field 'DetalleDua.fecha_embarque'
        db.alter_column('aduanet_detalledua', 'fecha_embarque', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'DetalleDua.fech_vencimiento'
        db.alter_column('aduanet_detalledua', 'fech_vencimiento', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'DetalleDua.estado'
        db.alter_column('aduanet_detalledua', 'estado', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2))

        # Changing field 'DetalleDua.trato_pref'
        db.alter_column('aduanet_detalledua', 'trato_pref', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):
        # Deleting field 'DetalleDua.igv'
        db.delete_column('aduanet_detalledua', 'igv')

        # Deleting field 'DetalleDua.nabandina'
        db.delete_column('aduanet_detalledua', 'nabandina')

        # Deleting field 'DetalleDua.peso_neto'
        db.delete_column('aduanet_detalledua', 'peso_neto')
