...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CountryProduct'
        db.create_table('aduanet_countryproduct', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('aduanet', ['CountryProduct'])

        # Deleting field 'DetalleDua.pais_origen'
        db.delete_column('aduanet_detalledua', 'pais_origen')

        # Deleting field 'DetalleDua.pais_adquision'
        db.delete_column('aduanet_detalledua', 'pais_adquision')


    def backwards(self, orm):
        # Deleting model 'CountryProduct'
        db.delete_table('aduanet_countryproduct')
        ...
        # Adding field 'DetalleDua.pais_adquision'
        db.add_column('aduanet_detalledua', 'pais_adquision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)
