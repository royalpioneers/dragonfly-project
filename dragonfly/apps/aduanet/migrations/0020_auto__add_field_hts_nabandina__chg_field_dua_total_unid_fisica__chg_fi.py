...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hts.nabandina'
        db.add_column('aduanet_hts', 'nabandina',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Dua.total_unid_fisica'
        db.alter_column('aduanet_dua', 'total_unid_fisica', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'Dua.total_cant_bulto'
        db.alter_column('aduanet_dua', 'total_cant_bulto', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'Dua.sobretasa_natural'
        db.alter_column('aduanet_dua', 'sobretasa_natural', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'Dua.total_peso_neto'
        db.alter_column('aduanet_dua', 'total_peso_neto', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'Dua.ad_valorem'
        db.alter_column('aduanet_dua', 'ad_valorem', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'Dua.unid_comercial'
        db.alter_column('aduanet_dua', 'unid_comercial', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'Dua.derecho_especifico'
        db.alter_column('aduanet_dua', 'derecho_especifico', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'Dua.imp_general_venta'
        db.alter_column('aduanet_dua', 'imp_general_venta', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'Dua.derecho_antidumping'
        db.alter_column('aduanet_dua', 'derecho_antidumping', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'Dua.tasa_servicio'
        db.alter_column('aduanet_dua', 'tasa_servicio', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'Dua.fob'
        db.alter_column('aduanet_dua', 'fob', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'Dua.liquidacion'
        db.alter_column('aduanet_dua', 'liquidacion', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'Dua.imp_promocion_municipal'
        db.alter_column('aduanet_dua', 'imp_promocion_municipal', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'Dua.imp_select_consumo'
        db.alter_column('aduanet_dua', 'imp_select_consumo', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'Dua.total_peso_bruto'
        db.alter_column('aduanet_dua', 'total_peso_bruto', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'Dua.cif'
        db.alter_column('aduanet_dua', 'cif', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'Dua.seguro'
        db.alter_column('aduanet_dua', 'seguro', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'Dua.recargo_numeracion'
        db.alter_column('aduanet_dua', 'recargo_numeracion', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'Dua.flete'
        db.alter_column('aduanet_dua', 'flete', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))
        # Adding field 'Product.unid_comercial'
        db.add_column('aduanet_product', 'unid_comercial',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=20, blank=True),
                      keep_default=False)

        # Adding field 'Product.tipo_uc'
        db.add_column('aduanet_product', 'tipo_uc',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'DetalleDua.nabandina'
        db.delete_column('aduanet_detalledua', 'nabandina')

        # Deleting field 'DetalleDua.unid_comercial'
        db.delete_column('aduanet_detalledua', 'unid_comercial')

        # Deleting field 'DetalleDua.trato_pref'
        db.delete_column('aduanet_detalledua', 'trato_pref')

        # Deleting field 'DetalleDua.tipo_uc'
        db.delete_column('aduanet_detalledua', 'tipo_uc')

        # Adding field 'DetalleDua.trato_pref_int'
        db.add_column('aduanet_detalledua', 'trato_pref_int',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DetalleDua.trato_pref_nac'
        db.add_column('aduanet_detalledua', 'trato_pref_nac',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Hts.nabandina'
        db.delete_column('aduanet_hts', 'nabandina')
        ...
        # Changing field 'Dua.unid_comercial'
        db.alter_column('aduanet_dua', 'unid_comercial', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2))
        ...
        # Changing field 'Dua.cif'
        db.alter_column('aduanet_dua', 'cif', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))
        ...
        # Deleting field 'Product.unid_comercial'
        db.delete_column('aduanet_product', 'unid_comercial')

        # Deleting field 'Product.tipo_uc'
        db.delete_column('aduanet_product', 'tipo_uc')

        # Adding field 'DetalleDua.nabandina'
        db.add_column('aduanet_detalledua', 'nabandina',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DetalleDua.unid_comercial'
        db.add_column('aduanet_detalledua', 'unid_comercial',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=20, blank=True),
                      keep_default=False)

        # Adding field 'DetalleDua.trato_pref'
        db.add_column('aduanet_detalledua', 'trato_pref',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DetalleDua.tipo_uc'
        db.add_column('aduanet_detalledua', 'tipo_uc',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'DetalleDua.trato_pref_int'
        db.delete_column('aduanet_detalledua', 'trato_pref_int')

        # Deleting field 'DetalleDua.trato_pref_nac'
        db.delete_column('aduanet_detalledua', 'trato_pref_nac')
