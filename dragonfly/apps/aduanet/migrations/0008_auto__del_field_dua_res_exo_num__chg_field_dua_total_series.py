...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Dua.res_exo_num'
        db.delete_column('aduanet_dua', 'res_exo_num')


        # Changing field 'Dua.total_series'
        db.alter_column('aduanet_dua', 'total_series', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Adding field 'Dua.res_exo_num'
        db.add_column('aduanet_dua', 'res_exo_num',
