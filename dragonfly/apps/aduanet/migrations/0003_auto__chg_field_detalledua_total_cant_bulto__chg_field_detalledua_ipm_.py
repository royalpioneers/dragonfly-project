...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('aduanet_detalledua', 'total_cant_bulto', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2))

        # Changing field 'DetalleDua.ipm'
        db.alter_column('aduanet_detalledua', 'ipm', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2))

        # Changing field 'DetalleDua.ad_valorem'
        db.alter_column('aduanet_detalledua', 'ad_valorem', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2))

        # Changing field 'DetalleDua.igv'
        db.alter_column('aduanet_detalledua', 'igv', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2))

        # Changing field 'DetalleDua.peso_bruto'
        db.alter_column('aduanet_detalledua', 'peso_bruto', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2))

        # Changing field 'DetalleDua.peso_neto'
        db.alter_column('aduanet_detalledua', 'peso_neto', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2))

        # Changing field 'DetalleDua.seguro'
        db.alter_column('aduanet_detalledua', 'seguro', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2))

        # Changing field 'DetalleDua.isc'
        db.alter_column('aduanet_detalledua', 'isc', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2))

        # Changing field 'DetalleDua.flete'
        db.alter_column('aduanet_detalledua', 'flete', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'DetalleDua.total_cant_bulto'
        db.alter_column('aduanet_detalledua', 'total_cant_bulto', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))
        ...
        # Changing field 'DetalleDua.igv'
        db.alter_column('aduanet_detalledua', 'igv', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))
        ...
        # Changing field 'DetalleDua.peso_neto'
        db.alter_column('aduanet_detalledua', 'peso_neto', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))
    ...
    models = {
        ...
        'aduanet.detalledua': {
            ...
            'ad_valorem': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '2', 'blank': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'igv': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '2', 'blank': 'True'}),
            'ipm': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '2', 'blank': 'True'}),
            'isc': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '2', 'blank': 'True'}),
            ...
            'peso_bruto': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '2', 'blank': 'True'}),
            'peso_neto': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '2', 'blank': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['aduanet.Product']", 'null': 'True', 'blank': 'True'}),
            'seguro': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '2', 'blank': 'True'}),
            ...
            'total_cant_bulto': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '2', 'blank': 'True'}),
        ...
        'aduanet.hts': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nabandina': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'})
        },
        'aduanet.importer': {
