...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Dua.code'
        db.alter_column('aduanet_dua', 'code', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Dua.code'
        db.alter_column('aduanet_dua', 'code', self.gf('django.db.models.fields.CharField')(max_length=15))
